...
const SignUp = () => {
    ...
    const HandleForm = (e) => {
        e.preventDefault();
        // Redirect to client dashboard after form submission
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main>
                {/* ================= Condition Section =================== */}
                {clientForm ? null : <section className="container mx-auto xl:my-14 lg:my-10 md:my-7 my-5 py-3 md:px-5 sm:px-7 px-3 md:flex md:justify-center">
                    <div className="sm:border border-gray-300 rounded-xl">
                        <div className="lg:px-24 md:px-20 sm:px-10 sm:pt-10 pb-10 flex flex-col justify-center md:items-center">
                            ...
                            <div className={`bg-[#e5ecea] hover:bg-[#d1dfdb] rounded-xl py-7 sm:px-8 px-5 flex flex-col items-center space-y-4 md:max-w-[17rem] md:w-auto w-full cursor-pointer transition mt-10`} onClick={ClientHandle}>
                                <div>
                                    <FcConferenceCall className="text-5xl"/>
                                </div>
                                <div>
                                    <h4 className={`text-zinc-800 font-semibold text-lg text-center`}>
                            ...
                            {/* =============== Button =================== */}
                            <button className={`bg-[#e5ecea] hover:bg-[#d1dfdb] text-gray-500 py-2 md:px-20 px-3 mt-10 rounded-full font-semibold transition md:w-auto w-full`} onClick={ClientHandle}>
                                {btnText}
                            </button>
